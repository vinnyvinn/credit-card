<template>
 <div id="app">
    <form ref="form" class="card-form">
      <header>
        <h1 class="card-form__title">Credit Card Information</h1>
      </header>
      ...
      <button type="submit" class="card-form__submit" @click="displayInfo()">PAY</button>
      ...
      <div v-if="display">
        ...
        name: {{ card.owner }}
        <br>
        expiry: {{ card.expiration.month }}/{{ card.expiration.year }}
        <br>
          cvc: {{ card.cvc }}     
      </div>
